...
fn test_unreachable_path() {
    ...
    test_query_file("/../src/main.rs", None, Status::NotFound);
    test_query_file("/../blargle?blargle=blargle", None, Status::NotFound);
}

#[test]
fn test_tetris_index_html() {
    test_query_file("/tetris", "static/tetris/index.html", Status::Ok);
    test_query_file("/tetris/", "static/tetris/index.html", Status::Ok);
    test_query_file("/tetris/index.html", "static/tetris/index.html", Status::Ok);
}

#[test]
fn test_tetris_program_wasm() {
    test_query_file("/tetris/program.wasm", "static/tetris/program.wasm", Status::Ok);
    test_query_file("/../tetris/program.wasm", "static/tetris/program.wasm", Status::Ok);
}